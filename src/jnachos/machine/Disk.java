...
public class Disk implements VoidFunctionPtr {
	...
	/**
	 * Number of sectors in a fragment
	 */
	public static final int NUM_OF_SECTORS_IN_A_FRAGMENT = 2;

	/**
	 * Number of fragments in a block
	 */
	public static final int NUM_OF_FRAGMENTS_IN_A_BLOCK = 2;

	/**
	 * Size of a fragment
	 */
	public static final int SINGLE_FRAGMENT_SIZE = Disk.SectorSize * NUM_OF_SECTORS_IN_A_FRAGMENT;

	/**
	 * Size of a block
	 */
	public static final int SINGLE_BLOCK_SIZE = SINGLE_FRAGMENT_SIZE * NUM_OF_FRAGMENTS_IN_A_BLOCK;

	/**
	 * Total number of sectors in a block
	 */
	public static final int NUM_OF_SECTORS_IN_A_BLOCK = NUM_OF_SECTORS_IN_A_FRAGMENT * NUM_OF_FRAGMENTS_IN_A_BLOCK;
